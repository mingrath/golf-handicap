...
Plans:
- [x] 16-01-PLAN.md — Store infrastructure: historyId field + loadHistoryGame action + history-aware save hook
- [x] 16-02-PLAN.md — UI wiring: clickable history cards + history-mode results page
...
| 16. History Game Loading & Editing | v1.3 | 2/2 | Complete | 2026-02-23 |
