# Requirements Archive: v1.3 Handicap Control & History Editing
...
- [x] **HCTL-01**: User can see which holes currently have handicap strokes when editing a pair's handicap
- [x] **HCTL-02**: User can manually toggle individual holes on/off for handicap strokes (instead of only auto-distribute)
- [x] **HCTL-03**: When user changes handicap value, the app shows current hole selections and lets user adjust which holes to add/remove

### History Editing

- [x] **HIST-01**: User can tap a past game in the history list to open it in a detail/results view
- [x] **HIST-02**: User can edit scores (strokes per hole per player) of a past game
- [x] **HIST-03**: User can edit handicap values and handicap hole assignments of a past game
- [x] **HIST-04**: Edits to a past game recalculate all scores, rankings, and storytelling, and persist back to IndexedDB
